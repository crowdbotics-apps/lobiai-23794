"""lobiai_23794 URL Configuration
...
admin.site.site_header = "Lobiai"
admin.site.site_title = "Lobiai Admin Portal"
admin.site.index_title = "Lobiai Admin"

# swagger
api_info = openapi.Info(
    title="Lobiai API",
    default_version="v1",
    description="API documentation for Lobiai App",
)
